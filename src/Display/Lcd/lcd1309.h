...
// Class for driving 128x64 graphical LCD fitted with SSD1309 controller

class Lcd1309 : public Lcd
{
public:
	// Construct a GLCD driver.
	Lcd1309(const LcdFont * const fnts[], size_t nFonts);
